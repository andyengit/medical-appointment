...
<body style="display: flex; flex-direction:column;flex-wrap: wrap">
    ...
    <header style="justify-content:flex-start;" class="topHeader">
        ...
        <div class="cuenta">
            <a href="<?= base_url ?>index.php?controller=user&&action=login"><button class="ui tiny primary button">ENTRAR</button></a>
            <a href="<?= base_url ?>index.php?controller=user&&action=register"><button class="ui inverted tiny primary button">REGISTRARSE</button></a>
        </div>
    </header>